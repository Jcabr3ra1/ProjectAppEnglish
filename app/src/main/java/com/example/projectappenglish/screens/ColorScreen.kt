...
fun ColorScreen() {
    ...
    val colors = listOf(
        Colors(R.drawable.red, R.raw.rojo, R.raw.red),
        Colors(R.drawable.yellow, R.raw.amarrillo, R.raw.yellow),
        Colors(R.drawable.blue, R.raw.azul, R.raw.blue),
        Colors(R.drawable.green, R.raw.verde, R.raw.green),
        Colors(R.drawable.purple, R.raw.morado, R.raw.purple),
        Colors(R.drawable.black, R.raw.negro, R.raw.black)
    )
